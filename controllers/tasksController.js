...
const taskController = {
    ...
    //TOFO: FIX DATE INPUT >> CURRENTLY SET DATE(NOW)
    async addEntry( req ){ return await new Tasks().addEntry( req.params.listId, req.body.id, req.body.name, new Date(), req.body.checked ) },
